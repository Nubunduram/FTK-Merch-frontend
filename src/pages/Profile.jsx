                ...
                <>
                        ...
                        {!editingUser ? (
                            ...
                            <form onSubmit={handleUpdateUser} className="space-y-3">
                                ...
                                <div className="flex gap-3">
                                    ...
                                    <button type="button" onClick={() => setEditingUser(false)} className="px-4 py-2 bg-gray-300 rounded hover:bg-gray-400">
                                        Annuler
                                    </button>
                                </div>
                            </form>
                    ...
                    <section className="bg-white p-6 rounded-xl shadow">
                        ...
                        <ul className="space-y-4">
                            {addresses.map(addr => (
                                <li key={addr.id} className="border p-4 rounded-lg bg-gray-50">
